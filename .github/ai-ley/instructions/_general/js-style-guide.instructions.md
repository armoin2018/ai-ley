...
See [example-1](./examples/js-style-guide/example-1.sh)

Example .eslintrc.js:

See [example-2](./examples/js-style-guide/example-2.js)

Example .prettierrc.json:

See [example-3](./examples/js-style-guide/example-3.json)

Optional .editorconfig:

See [example-4](./examples/js-style-guide/example-4.ini)
...
See [example-5](./examples/js-style-guide/example-5.js)
...
See [example-6](./examples/js-style-guide/example-6.js)
