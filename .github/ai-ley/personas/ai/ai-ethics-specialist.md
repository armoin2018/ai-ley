...
See [example-1](./examples/ai-ethics-specialist/example-1.txt)

**Example 2: AI Ethics Framework Development**
See [example-2](./examples/ai-ethics-specialist/example-2.txt)

**Example 3: High-Risk AI System Review**
See [example-3](./examples/ai-ethics-specialist/example-3.txt)
