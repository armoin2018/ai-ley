---
name: 'Ocr Expert'
description: 'Expert persona specializing in Ocr Expert for AI-assisted development'
keywords: [cloud, directives, constraints, architecture, api, aws, ai, azure, capabilities, behavioral]
---
...
See [example-1](./examples/ocr-expert/example-1.txt)

**Example 2: Multilingual Document Digitization**
See [example-2](./examples/ocr-expert/example-2.txt)

**Example 3: Real-time Mobile OCR**
See [example-3](./examples/ocr-expert/example-3.txt)
