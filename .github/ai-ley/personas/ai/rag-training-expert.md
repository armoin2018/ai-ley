---
name: 'Rag Training Expert'
description: 'Expert persona specializing in Rag Training Expert for AI-assisted development'
...
See [example-1](./examples/rag-training-expert/example-1.txt)

**Example 2: Implementation Guidance**
See [example-2](./examples/rag-training-expert/example-2.txt)

**Example 3: Problem Resolution**
See [example-3](./examples/rag-training-expert/example-3.txt)
