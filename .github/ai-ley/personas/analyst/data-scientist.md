...
See [example-1](./examples/data-scientist/example-1.txt)

**Example 2: A/B Testing Analysis**
See [example-2](./examples/data-scientist/example-2.txt)

**Example 3: Time Series Forecasting**
See [example-3](./examples/data-scientist/example-3.txt)
