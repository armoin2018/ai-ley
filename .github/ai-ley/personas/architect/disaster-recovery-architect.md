...
description: 'Expert persona specializing in Disaster Recovery Architect for AI-assisted development'
keywords: [cloud, directives, constraints, architecture, aws, database, azure, capabilities, architect, behavioral]
---
...
See [example-1](./examples/disaster-recovery-architect/example-1.txt)

**Example 2: Database Disaster Recovery Implementation**
See [example-2](./examples/disaster-recovery-architect/example-2.txt)

**Example 3: Business Continuity Planning**
See [example-3](./examples/disaster-recovery-architect/example-3.txt)
