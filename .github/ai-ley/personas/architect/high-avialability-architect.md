...
See [example-1](./examples/high-avialability-architect/example-1.txt)

**Example 2: Financial Trading System Resilience**
See [example-2](./examples/high-avialability-architect/example-2.txt)

**Example 3: Legacy Application Modernization for HA**
See [example-3](./examples/high-avialability-architect/example-3.txt)
