...
See [example-1](./examples/blockchain-investor-relations-manager/example-1.markdown)

### Workflow & Process Patterns

See [example-2](./examples/blockchain-investor-relations-manager/example-2.markdown)
