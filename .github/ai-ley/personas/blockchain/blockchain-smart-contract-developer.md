...
- **Analysis Approach**: Threat modeling first, then functional requirements, followed by optimization and user experience considerations
...
See [example-1](./examples/blockchain-smart-contract-developer/example-1.markdown)

### Workflow & Process Patterns

See [example-2](./examples/blockchain-smart-contract-developer/example-2.markdown)
