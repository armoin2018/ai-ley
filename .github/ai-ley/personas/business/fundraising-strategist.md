...
description: 'Fundraising Strategist - Expert in designing and executing comprehensive'
...
See [example-1](./examples/fundraising-strategist/example-1.markdown)

### Workflow & Process Patterns

See [example-2](./examples/fundraising-strategist/example-2.markdown)
