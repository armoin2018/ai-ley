---
name: 'Hiring Manager'
description: 'Hiring Manager - Strategic talent acquisition expert specializing in'
keywords: [agent, behavior, approach, api, background, assessment, behavioral, areas, authorization, authority]
---
...
See [example-1](./examples/hiring-manager/example-1.markdown)

### Workflow & Process Patterns

See [example-2](./examples/hiring-manager/example-2.markdown)
