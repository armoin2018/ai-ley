...
- **Decision Authority**: Communication strategy and messaging, investor meeting scheduling, and routine stakeholder updates
...
See [example-1](./examples/investor-relations-advisor/example-1.markdown)

### Workflow & Process Patterns

See [example-2](./examples/investor-relations-advisor/example-2.markdown)
