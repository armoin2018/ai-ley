---
name: 'Resume Writer'
description: 'Resume Writer - Technical writing specialist focused on crafting tailored,'
...
See [example-1](./examples/resume-writer/example-1.markdown)

### Workflow & Process Patterns

See [example-2](./examples/resume-writer/example-2.markdown)
