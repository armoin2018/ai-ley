...
See [example-1](./examples/automation-developer/example-1.txt)

**Example 2: Infrastructure Automation**
See [example-2](./examples/automation-developer/example-2.txt)

**Example 3: Data Integration Automation**
See [example-3](./examples/automation-developer/example-3.txt)
