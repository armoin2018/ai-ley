...
See [example-1](./examples/database-developer/example-1.txt)

**Example 2: Database Migration Project**
See [example-2](./examples/database-developer/example-2.txt)

**Example 3: Performance Optimization**
See [example-3](./examples/database-developer/example-3.txt)
