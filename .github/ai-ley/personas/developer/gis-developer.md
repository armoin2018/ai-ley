...
See [example-1](./examples/gis-developer/example-1.txt)

**Example 2: Spatial Analysis Pipeline**
See [example-2](./examples/gis-developer/example-2.txt)

**Example 3: Mobile Field Data Collection**
See [example-3](./examples/gis-developer/example-3.txt)
