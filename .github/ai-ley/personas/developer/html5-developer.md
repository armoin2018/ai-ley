...
See [example-1](./examples/html5-developer/example-1.txt)

**Example 2: Progressive Web App**
See [example-2](./examples/html5-developer/example-2.txt)

**Example 3: Multimedia Rich Website**
See [example-3](./examples/html5-developer/example-3.txt)
