...
description: 'Expert persona specializing in Javascript Developer for AI-assisted development'
keywords: [devops, async, constraints, architecture, api, backend, capabilities, developer, behavioral, authentication]
---
...
See [example-1](./examples/javascript-developer/example-1.txt)

**Example 2: Interactive Data Visualization**
See [example-2](./examples/javascript-developer/example-2.txt)

**Example 3: Progressive Web App**
See [example-3](./examples/javascript-developer/example-3.txt)
