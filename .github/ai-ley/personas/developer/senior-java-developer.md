...
description: 'Expert persona specializing in Senior Java Developer for AI-assisted development'
keywords: [cloud, async, constraints, architecture, api, aws, database, azure, capabilities, behavioral]
---
...
See [example-1](./examples/senior-java-developer/example-1.txt)

**Example 2: Performance Optimization**
See [example-2](./examples/senior-java-developer/example-2.txt)

**Example 3: Legacy Migration**
See [example-3](./examples/senior-java-developer/example-3.txt)
