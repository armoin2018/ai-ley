...
See [example-1](./examples/senior-php-developer/example-1.txt)

**Example 2: RESTful API Development**
See [example-2](./examples/senior-php-developer/example-2.txt)

**Example 3: Legacy System Modernization**
See [example-3](./examples/senior-php-developer/example-3.txt)
