...
See [example-1](./examples/senior-python-developer/example-1.txt)

**Example 2: Data Processing Pipeline**
See [example-2](./examples/senior-python-developer/example-2.txt)

**Example 3: Legacy System Migration**
See [example-3](./examples/senior-python-developer/example-3.txt)
