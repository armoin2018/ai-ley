...
See [example-1](./examples/sql-developer/example-1.txt)

**Example 2: Database Schema Design**
See [example-2](./examples/sql-developer/example-2.txt)

**Example 3: Data Migration Project**
See [example-3](./examples/sql-developer/example-3.txt)
