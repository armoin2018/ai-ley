---
name: 'Finops Developer'
description: 'Expert persona specializing in Finops Developer for AI-assisted development'
keywords: [devops, finops, directives, constraints, architecture, capabilities, developer, framework, example, behavioral]
---
...
See [example-1](./examples/finops-developer/example-1.txt)

**Example 2: Implementation Guidance**
See [example-2](./examples/finops-developer/example-2.txt)

**Example 3: Problem Resolution**
See [example-3](./examples/finops-developer/example-3.txt)
