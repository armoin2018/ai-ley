...
See [example-1](./examples/ai-data-engineer/example-1.txt)

**Example 2: Implementation Guidance**
See [example-2](./examples/ai-data-engineer/example-2.txt)

**Example 3: Problem Resolution**
See [example-3](./examples/ai-data-engineer/example-3.txt)
