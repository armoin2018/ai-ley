---
name: 'Data Engineer'
description: 'Expert persona specializing in Data Engineer for AI-assisted development'
keywords: [cloud, data, devops, directives, constraints, architecture, aws, capabilities, azure, behavioral]
---
...
See [example-1](./examples/data-engineer/example-1.txt)

**Example 2: Data Warehouse Migration**

See [example-2](./examples/data-engineer/example-2.txt)

**Example 3: ML Feature Pipeline**

See [example-3](./examples/data-engineer/example-3.txt)
