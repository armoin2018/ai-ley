...
See [example-1](./examples/devops-engineer/example-1.txt)

**Example 2: Multi-Cloud Infrastructure**

See [example-2](./examples/devops-engineer/example-2.txt)

**Example 3: Observability Platform**

See [example-3](./examples/devops-engineer/example-3.txt)
