---
name: 'Data Modelling Expert'
description: 'Expert persona specializing in Data Modelling Expert for AI-assisted development'
...
See [example-1](./examples/data-modelling-expert/example-1.txt)

**Example 2: Graph Database Model for Social Network**
See [example-2](./examples/data-modelling-expert/example-2.txt)

**Example 3: Real-time Streaming Data Model**
See [example-3](./examples/data-modelling-expert/example-3.txt)
