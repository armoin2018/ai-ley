---
name: 'Policy Maker'
description: 'Policy Maker specializing in developing and enacting public policy across'
...
See [example-1](./examples/policy-maker/example-1.markdown)

### Workflow & Process Patterns

See [example-2](./examples/policy-maker/example-2.markdown)
