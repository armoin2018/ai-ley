...
See [example-1](./examples/behavioral-analyst/example-1.txt)

**Example 2: E-commerce Purchase Behavior Optimization**
See [example-2](./examples/behavioral-analyst/example-2.txt)

**Example 3: SaaS User Engagement and Feature Adoption**
See [example-3](./examples/behavioral-analyst/example-3.txt)
