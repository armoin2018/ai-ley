---
name: 'Agile Expert'
description: 'Expert persona specializing in Agile Expert for AI-assisted development'
keywords: [devops, directives, constraints, cli, expert, capabilities, azure, example, agile, behavioral]
---
...
See [example-1](./examples/agile-expert/example-1.txt)

**Example 2: Agile Scaling Implementation**
See [example-2](./examples/agile-expert/example-2.txt)

**Example 3: Team Performance Optimization**
See [example-3](./examples/agile-expert/example-3.txt)
