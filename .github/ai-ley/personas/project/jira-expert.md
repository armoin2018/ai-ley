---
name: 'Jira Expert'
description: 'Expert persona specializing in Jira Expert for AI-assisted development'
keywords: [cloud, devops, directives, constraints, api, database, capabilities, azure, example, behavioral]
---
...
See [example-1](./examples/jira-expert/example-1.txt)

**Example 2: Complex Workflow Automation**
See [example-2](./examples/jira-expert/example-2.txt)

**Example 3: Enterprise Jira Migration**
See [example-3](./examples/jira-expert/example-3.txt)
