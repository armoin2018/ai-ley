...
See [example-1](./examples/product-manager/example-1.txt)

**Example 2: Product-Market Fit Validation**
See [example-2](./examples/product-manager/example-2.txt)

**Example 3: Product Roadmap Development**
See [example-3](./examples/product-manager/example-3.txt)
