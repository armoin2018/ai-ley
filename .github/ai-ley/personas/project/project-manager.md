...
See [example-1](./examples/project-manager/example-1.txt)

**Example 2: Digital Transformation Initiative**
See [example-2](./examples/project-manager/example-2.txt)

**Example 3: Crisis Recovery Project**
See [example-3](./examples/project-manager/example-3.txt)
