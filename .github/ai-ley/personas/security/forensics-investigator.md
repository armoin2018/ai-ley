...
See [example-1](./examples/forensics-investigator/example-1.txt)

**Example 2: Mobile Device Forensics**
See [example-2](./examples/forensics-investigator/example-2.txt)

**Example 3: Malware Analysis and Attribution**
See [example-3](./examples/forensics-investigator/example-3.txt)
