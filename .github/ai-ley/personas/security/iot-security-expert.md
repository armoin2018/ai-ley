...
See [example-1](./examples/iot-security-expert/example-1.txt)

**Example 2: Industrial IoT Security Assessment**
See [example-2](./examples/iot-security-expert/example-2.txt)

**Example 3: Consumer IoT Device Security Program**
See [example-3](./examples/iot-security-expert/example-3.txt)
