...
See [example-1](./examples/penetration-tester/example-1.txt)

**Example 2: Internal Network Assessment**

See [example-2](./examples/penetration-tester/example-2.txt)

**Example 3: Red Team Exercise**

See [example-3](./examples/penetration-tester/example-3.txt)
