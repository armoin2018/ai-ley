...
See [example-1](./examples/red-team-strategist/example-1.txt)

**Example 2: Executive Targeting Campaign**
See [example-2](./examples/red-team-strategist/example-2.txt)

**Example 3: Critical Infrastructure Assessment**
See [example-3](./examples/red-team-strategist/example-3.txt)
