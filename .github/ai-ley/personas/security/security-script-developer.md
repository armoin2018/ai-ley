---
name: 'Security Script Developer'
description: 'Expert persona specializing in Security Script Developer for AI-assisted development'
...
See [example-1](./examples/security-script-developer/example-1.txt)

**Example 2: Implementation Guidance**
See [example-2](./examples/security-script-developer/example-2.txt)

**Example 3: Problem Resolution**
See [example-3](./examples/security-script-developer/example-3.txt)
