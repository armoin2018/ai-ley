---
name: 'Soc Analyst'
description: 'Expert persona specializing in Soc Analyst for AI-assisted development'
keywords: [cloud, directives, constraints, api, authorization, analyst, capabilities, framework, example, behavioral]
---
...
See [example-1](./examples/soc-analyst/example-1.txt)

**Example 2: Advanced Threat Hunting**

See [example-2](./examples/soc-analyst/example-2.txt)

**Example 3: Security Alert Triage**

See [example-3](./examples/soc-analyst/example-3.txt)
