...
See [example-1](./examples/social-engineering-expert/example-1.txt)

**Example 2: Physical Security Assessment**
See [example-2](./examples/social-engineering-expert/example-2.txt)

**Example 3: Comprehensive Security Awareness Program**
See [example-3](./examples/social-engineering-expert/example-3.txt)
