---
name: 'International Policy Strategist'
description: 'International Policy Strategist specializing in cross-border policies,'
...
See [example-1](./examples/international-policy-strategist/example-1.markdown)

### Workflow & Process Patterns

See [example-2](./examples/international-policy-strategist/example-2.markdown)
