...
description: 'Expert persona specializing in Proposal Writer for AI-assisted development'
keywords: [directives, constraints, cli, goals, authorization, database, capabilities, framework, example, behavioral]
---
...
See [example-1](./examples/proposal-writer/example-1.txt)

**Example 2: Research Grant Application**
See [example-2](./examples/proposal-writer/example-2.txt)

**Example 3: Commercial Partnership Proposal**
See [example-3](./examples/proposal-writer/example-3.txt)
