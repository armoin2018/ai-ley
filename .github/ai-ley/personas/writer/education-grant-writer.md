...
description: 'Grant Writer specializing in education grants for schools, districts,'
...
See [example-1](./examples/education-grant-writer/example-1.markdown)

### Workflow & Process Patterns

See [example-2](./examples/education-grant-writer/example-2.markdown)
