...
- Reference quality standards from `.github/prompts/update-instructions.md` for instruction assessment
- Reference quality standards from `.github/prompts/update-personas.md` for persona assessment
...
- Set up appropriate file paths and assessment criteria based on target type:
  - Instructions: `.github/ai-ley/instructions/**/*.md` (evaluated against update-instructions.md standards)
  - Personas: `.github/ai-ley/personas/**/*.md` (evaluated against update-personas.md standards)
  - Prompts: `.github/prompts/**/*.md` (evaluated against general prompt standards)
...
- Read and parse `.github/prompts/update-instructions.md` for quality criteria
...
- Read and parse `.github/prompts/update-personas.md` for quality criteria
...
- Based on standards from: `.github/prompts/update-instructions.md`
- Template compliance, technical accuracy, actionability

### Personas Assessment

- Based on standards from: `.github/prompts/update-personas.md`
