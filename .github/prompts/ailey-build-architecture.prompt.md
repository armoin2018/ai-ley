...
- `.github/ai-ley/personas/architect/**/*.md`
...
- `.github/ai-ley/instructions/development/architecture/**/*.md`
- `.github/ai-ley/instructions/best-practices/architecture/**/*.md`
...
- **Inputs:** `{{files.requirements}}`, `{{files.plan}}`, all files in `.github/ai-ley/personas`, and `.github/ai-ley/instructions`.
- **Outputs:**
...
> Date: {{iso_date}} | Owner: Architecture | Sources: {{files.requirements}}, {{files.plan}}, .github/ai-ley/personas, .github/ai-ley/instructions
