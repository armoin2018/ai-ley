...
- `.github/ai-ley/instructions/web-design/**/*.md`
- `.github/ai-ley/instructions/best-practices/design/**/*.md`

These provide domain-specific guidance and best practices.

## Recommended Agent

This prompt works best with the **ailey-designer** agent from `.github/agents/ailey-designer.agent.md`.
...
- **Inputs:** `{{files.requirements}}`, `{{files.plan}}`, all files in `.github/ai-ley/personas`, `.github/ai-ley/instructions`.
- **Outputs:**
