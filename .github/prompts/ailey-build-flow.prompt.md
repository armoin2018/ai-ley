...
Load and analyze all existing commands from `.github/prompts/*.md`:
...
rectangle "command-name" as cmd1 {
    ...
    note : **Command**: `.github/prompts/{command}.md`
...
1. **Command Rectangles**: Represent existing AI-LEY prompts
   ...
   rectangle "requirements" as req {
       ...
       note : **Command**: `.github/prompts/requirements.md`
...
rectangle "plan" as plan_cmd {
    ...
    note : **Command**: `.github/prompts/plan.md`
    note : **Output**: {{files.plan}}
}

rectangle "run" as run_cmd {
    note : **Input**: {{files.plan}}
    note : **Command**: `.github/prompts/run.md`
