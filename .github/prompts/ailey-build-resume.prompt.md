...
- Load resume consultant persona from `.github/ai-ley/personas/business/resume-consultant.md`
- Load resume writer persona from `.github/ai-ley/personas/business/resume-writer.md`
- Load ATS optimization instructions from `.github/ai-ley/instructions/business/ats-optimization.instructions.md`
