...
- Existing resources in `.github/ai-ley/instructions` and `.github/ai-ley/personas`
- Enhancement strategies from `update-instructions.md` and `update-personas.md`

Produce:

- New and enhanced instruction files in `.github/ai-ley/instructions/**/*.md`
- New and enhanced persona files in `.github/ai-ley/personas/**/*.md`
...
- Load `.github/prompts/update-instructions.md` for instruction evolution framework
- Load `.github/prompts/update-personas.md` for persona enhancement methodology
...
- Scan all existing instructions in `.github/ai-ley/instructions/**/*.md`
- Scan all existing personas in `.github/ai-ley/personas/**/*.md`
...
- Scanning existing instructions in .github/ai-ley/instructions/\*_/_.md
