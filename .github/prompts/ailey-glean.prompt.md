...
### 2. Update: `.github/ai-ley/instructions/security/jwt-authentication.md`
...
### 2. New: `.github/ai-ley/instructions/validation/joi-validation.md`
...
### mongoose-schemas
- **Path**: `.github/ai-ley/instructions/database/mongoose-schemas.md`
...
### rest-api-design
- **Path**: `.github/ai-ley/instructions/api/rest-api-design-generated.md`
...
- **Path**: `.github/ai-ley/personas/developer/api-developer.md`
...
- **Path**: `.github/ai-ley/personas/developer/backend-developer-generated.md`
...
- **Path**: `.github/prompts/generate-openapi-spec.md`
...
2. **joi-validation.md**
   - **Path**: `.github/ai-ley/instructions/validation/joi-validation.md`
...
4. Show diffs of what would be created/updated:
   ...
   ```diff
   # Would create: .github/ai-ley/instructions/database/mongoose-schemas.md
...
1. `.github/ai-ley/instructions/database/mongoose-schemas.md`
2. `.github/ai-ley/instructions/validation/joi-validation.md`
3. `.github/ai-ley/personas/developer/api-developer.md`
4. `.github/prompts/generate-openapi-spec.md`
5. (Template) `{{folders.templates.instructions}}/database-instruction-template.md`

### Updated Assets (3)

1. `.github/ai-ley/instructions/security/jwt-authentication-generated.md`
2. `.github/ai-ley/instructions/api/rest-api-design-generated.md`
3. `.github/ai-ley/personas/developer/backend-developer-generated.md`
