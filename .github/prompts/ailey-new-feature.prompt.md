...
keywords: [feature, requirements, build-plan, run-plan, automation, workflow, prompt, ailey]
---
...
- Follow all steps from `.github/prompts/build-plan.md`
...
- Follow all steps from `.github/prompts/run-plan.md`
