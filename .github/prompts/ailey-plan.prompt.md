...
- `.github/ai-ley/instructions/development/planning/**/*.md`
- `.github/ai-ley/instructions/best-practices/project-management/**/*.md`

These provide domain-specific guidance and best practices.

## Recommended Agent

This prompt works best with the **ailey-planner** agent from `.github/agents/ailey-planner.agent.md`.
...
- Map requirements to available personas in `.github/ai-ley/personas`
- Map requirements to available instructions in `.github/ai-ley/instructions`
...
**Primary Persona**: `.github/ai-ley/personas/[best-match-persona].md` (Confidence: X%)
...
- `.github/ai-ley/personas/[secondary-persona].md` (For [specific aspect])
- `.github/ai-ley/personas/[review-persona].md` (For quality assurance)

**Instructions**:

- `.github/ai-ley/instructions/[primary-instruction].md` (Relevance: X%)
- `.github/ai-ley/instructions/[secondary-instruction].md` (For [specific guidance])
...
**Optimal Persona**: `.github/ai-ley/personas/[selected-persona].md`
...
- **Primary**: `.github/ai-ley/instructions/[main-instruction].md` (Relevance: X%)
- **Secondary**: `.github/ai-ley/instructions/[supporting-instruction].md` (For [specific aspect])

**Alternative Assignments** (if primary is unavailable):

- **Backup Persona**: `.github/ai-ley/personas/[alternative-persona].md`
...
- **Story 1.1**: `.github/ai-ley/personas/devops-engineer.md` (Score: 95/100)
  - **Rationale**: Perfect match for infrastructure and CI/CD expertise
  - **Supporting**: `.github/ai-ley/personas/senior-developer.md` (for code review)
- **Story 1.2**: `.github/ai-ley/personas/technical-architect.md` (Score: 92/100)
  - **Rationale**: High-level design and architectural decision expertise

**Epic 2: Core Features**

- **Story 2.1**: `.github/ai-ley/personas/backend-developer.md` (Score: 88/100)
  - **Rationale**: API development and database design specialization
  - **Supporting**: `.github/ai-ley/personas/security-specialist.md` (for security review)

### Instruction Mapping by Technical Area

**Infrastructure & DevOps**:

- Primary: `.github/ai-ley/instructions/cicd-pipeline-setup.md`
- Secondary: `.github/ai-ley/instructions/containerization-best-practices.md`

**Backend Development**:

- Primary: `.github/ai-ley/instructions/api-design-patterns.md`
- Secondary: `.github/ai-ley/instructions/database-optimization.md`

**Frontend Development**:

- Primary: `.github/ai-ley/instructions/react-component-architecture.md`
- Secondary: `.github/ai-ley/instructions/responsive-design-principles.md`

## Team Structure and Roles

**Core Team** (based on available personas):

- **Technical Lead**: `.github/ai-ley/personas/technical-architect.md`

  - **Assignment Confidence**: 95%
  - **Workload**: Architecture design, complex implementation tasks
  - **Backup**: `.github/ai-ley/personas/senior-developer.md`

- **Senior Developer**: `.github/ai-ley/personas/senior-developer.md`
...
- **Frontend Developer**: `.github/ai-ley/personas/frontend-developer.md`
...
- **Backend Developer**: `.github/ai-ley/personas/backend-developer.md`
...
- **DevOps Engineer**: `.github/ai-ley/personas/devops-engineer.md`
...
- **QA Engineer**: `.github/ai-ley/personas/qa-engineer.md`
...
- `.github/ai-ley/personas/devops-engineer.md`: 95% utilization

  - **Risk**: Single point of failure for infrastructure
  - **Mitigation**: Cross-train Senior Developer on deployment processes

- `.github/ai-ley/personas/backend-developer.md`: 90% utilization
...
- `.github/ai-ley/personas/frontend-developer.md`: 75% utilization
- `.github/ai-ley/personas/qa-engineer.md`: 70% utilization

**Low Utilization Personas** (<60% allocation):

- `.github/ai-ley/personas/technical-architect.md`: 55% utilization
