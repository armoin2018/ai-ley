...
- Existing prompt files in `.github/prompts/*.md`
...
- List all existing files in `.github/prompts/*.md`
...
```
🔧 Scanning .github/prompts/ for source files...
...
- Source: `.github/prompts/build-plan.md`
...
- Source prompts in `.github/prompts/` are considered the single source of truth
