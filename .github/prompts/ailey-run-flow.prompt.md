...
- Map flow components to available AI-LEY commands in `.github/prompts/`
...
1. **Command Rectangles**: Map to AI-LEY prompt files
   ...
   - Validate command availability in `.github/prompts/{command}.md`
...
- Load global instructions from `agent guidelines`
...
2. **Command Rectangle Execution**
   ...
   **Step 1: Command Preparation**
   ...
   - Load AI-LEY command from `.github/prompts/{command}.md`
...
- Executing: `.github/prompts/requirements.md`
...
- Executing: `.github/prompts/plan.md`
...
- Executing: `.github/prompts/run.md`
- Input: {{files.plan}}
