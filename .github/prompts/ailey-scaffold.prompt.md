...
This prompt works best with the **ailey-architect** agent from `.github/agents/ailey-architect.agent.md`.
...
- Index files in `.github/ai-ley/instructions/../indexes/*.md`
...
3. Existing instructions: `.github/ai-ley/instructions/**/*.md`
4. Existing personas: `.github/ai-ley/personas/**/*.md`
...
- Parse `{{plan_path}}` for references to:
  - Instructions (e.g., `.github/ai-ley/instructions/path/to/instruction.md`)
  - Personas (e.g., `.github/ai-ley/personas/role/expert.md`)
...
- `.github/ai-ley/instructions/database/postgresql-best-practices.md`
...
- `.github/ai-ley/instructions/api/rest-design.md`
- `.github/ai-ley/personas/developer/backend-engineer.md`
...
- ✅ `.github/ai-ley/instructions/database/postgresql-best-practices.md`
- ✅ `.github/ai-ley/instructions/api/rest-design-patterns.md`
- ✅ `.github/ai-ley/personas/architect/database-architect.md`
- ✅ `.github/ai-ley/personas/architect/api-architect.md`
- ✅ `.github/ai-ley/personas/engineer/devops-engineer.md`
