...
keywords: [seo, analysis, website audit, technical seo, content optimization, performance analysis, recommendations, prompt, ailey]
---
...
- Utilize the SEO Expert persona from `.github/ai-ley/personas/marketing/seo-expert.md`
- Follow SEO report instructions from `.github/ai-ley/instructions/tools/seo/seo-report.instructions.md`
- Apply Technical Analyst expertise from `.github/ai-ley/personas/analyst/technical-analyst.md` for performance analysis
- Reference web accessibility guidelines from `.github/ai-ley/instructions/general/accessibility.instructions.md` if available
...
This prompt works best with the **ailey-marketing** agent from `.github/agents/ailey-marketing.agent.md`.
